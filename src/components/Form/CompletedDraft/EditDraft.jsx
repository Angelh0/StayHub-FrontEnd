    ...
    <div className="bg-black font-sans text-white">
      <div className="min-h-screen flex flex-col">
        ...
        <div className="grow flex w-full max-w-6xl mx-auto py-10 px-4 gap-8">
          <LeftMenu stepMenu={stepMenu} step={step} handleMenuClick={(s) => setStep(s)} />
          ...
          <div className="flex flex-col w-full md:w-3/4 bg-gray-950 p-8 border border-gray-800 shadow-2xl rounded-2xl justify-between">
            <div className="min-h-100">
              ...
              {step === 2 && <Step2StayConfig formData={formData} handleChange={handleChange} labelClasses={labelClasses} inputClasses={inputClasses} totalSteps={4} isEditing={true} />}
              {step === 3 && <Step3Calendar formData={formData} handleMonthToggle={handleMonthToggle} totalSteps={4} mesesDelAño={mesesDelAño} isEditing={true} />}
              {step === 4 && <Step4Photos openWidget={openWidget} formData={formData} removePhoto={removePhoto} totalSteps={4} isEditing={true} />}
            </div>
        ...
        <div className="w-full min-h-24 bg-black flex items-center justify-center border-t border-gray-800 mt-auto">
          <Footer />
        </div>
      </div>
    </div>
