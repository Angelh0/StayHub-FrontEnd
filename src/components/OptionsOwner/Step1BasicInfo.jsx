...
const Step1BasicInfo = ({ formData, handleChange, labelClasses, inputClasses }) => {
  return (
    <div className="space-y-4 flex-col">
      <div className="flex items-baseline justify-between gap-3 mb-1">
        ...
        <span className="text-yellow-400/50 px-5">Paso 1 de 5</span>
      </div>
      <p className="text-gray-500/50 py-3">
        Este paso crea el alojamiento, completa los 5 pasos para publicarlo
      </p>
